              ...
              <c:choose>
                <c:when test='${artclList != null}'>
                  <c:forEach var="list" items="${artclList }">
                    <c:if test="${list.type == '공지사항'}">
                      <tr>
                        <td>
                          ${list.artclSeq }
                        </td>
                        <td>
                          <a href="${pageContext.request.contextPath }/notice/artclDetailView?artclSeq=${list.artclSeq}">
                            ${list.title }
                          </a>
                        </td>
                        <td>
                        ...
                        <td>
                          <fmt:formatDate value="${list.regDate }" type="date"/>
                        </td>
                        <td>
                          ${list.hit }
                        </td>
